...
<section id="enroll-container">
        <h2>회원 가입 정보 입력</h2>
        <form name="enrollMemberFrm" action="${path }/member/enrollMemberEnd.do" method="post" onsubmit="return fn_invalidate();" >
        <table>
			<tr>
				<th>아이디</th>
				<td>
				...
				const fn_idduplicate=()=>{
					...
					if(userId.trim().length<4){
						...
						duplicateId.action="${path}/member/idDuplicate.do";
